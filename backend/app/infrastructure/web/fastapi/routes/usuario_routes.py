...
def login(usuario: UsuarioLogin, db: Session = Depends(get_db)):
    user_entity = autenticar_usuario_use_case(usuario.correo, usuario.contrasena, db)
    return UsuarioRead(idUsuario=user_entity.idUsuario, nombre=user_entity.nombre, correo=user_entity.correo)

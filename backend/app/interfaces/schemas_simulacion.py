...
# Schema para crear una simulación
class SimulacionCreate(BaseModel):
    nombreSimulacion: str = Field(..., description="Nombre descriptivo de la simulación")
    fechaInicio: date = Field(..., description="Fecha de inicio del periodo a simular")
    fechaFin: date = Field(..., description="Fecha de fin del periodo a simular")
...
# Schema para actualizar una simulación
class SimulacionUpdate(BaseModel):
    nombreSimulacion: Optional[str] = Field(None, description="Nombre descriptivo de la simulación")
    fechaInicio: Optional[date] = Field(None, description="Fecha de inicio del periodo a simular")
    fechaFin: Optional[date] = Field(None, description="Fecha de fin del periodo a simular")
...
# Schema para la respuesta de simulaciones
